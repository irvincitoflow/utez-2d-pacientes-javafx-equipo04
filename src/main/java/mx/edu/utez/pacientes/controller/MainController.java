...
public class MainController {
    ...
    public void initialize() {
        // Vinculación de columnas con atributos del modelo
    ...
    public void onNuevo() {
        try {
            // NOTA: Si moviste los FXML a una carpeta 'view', agrega /view/ aquí
            // Cambia la línea 49 por esta:
    ...
    public void onEditar() {
        ...
        if (seleccionado != null) {
            try {
                ...
                // 3. PASARLE LOS DATOS (Necesitamos crear este método en FormController)
                ...
                // 4. Al cerrar, refrescar la tabla
                tblPacientes.refresh();
                actualizarResumen();
    ...
    // MÉTODO QUE TE FALTABA Y CAUSABA LOS ERRORES EN TU FOTO
